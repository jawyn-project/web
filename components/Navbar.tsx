export function Navbar(props: { customCss?: string}) {

    const navClass = `bg-white w-full py-6 ${props.customCss || ''}`
                ...
                <div class="relative flex h-16 items-center justify-between">
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="flex items-center ml-auto">
                            ...
                            <a href="https://github.com/jawyn-project/" class="text-gray-950 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 text-lg font-light">sobre</a>
                        </div>
                    </div>
                </div>
            </div>
